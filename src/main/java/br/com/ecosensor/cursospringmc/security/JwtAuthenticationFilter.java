...
import br.com.ecosensor.cursospringmc.dto.CredentialsDTO;
...
public class JwtAuthenticationFilter
	...
	public Authentication attemptAuthentication(HttpServletRequest request,
		...
		try {
			...
			UsernamePasswordAuthenticationToken token = new UsernamePasswordAuthenticationToken(
					credentials.getUsername(), credentials.getPassword(), auth);
	...
	protected void successfulAuthentication(HttpServletRequest request,
		...
		UserSpringSecurity userSpringSecurity = (UserSpringSecurity) authResult
				.getPrincipal();
		String username = userSpringSecurity.getUsername();
		/**
		 * String username = ((UserSpringSecurity)
	...
	private class JWTAuthenticationFailureHandler
