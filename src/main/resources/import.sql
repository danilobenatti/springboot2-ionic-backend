...
insert into tbl_product(col_name, col_price) values ('Computador', 2000.00), ('Impressora', 800.00), ('Mouse', 80.00);
...
insert into tbl_payment_creditcard(id_order, col_number_of_installments) values (1, 6);
...
insert into tbl_payment_slipbank(id_order, col_pay_day, col_expiration_date) values (2, null, '2017-10-20 00:00');
